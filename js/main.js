...
function openDrawer() {
    ...
    if (drawer) {
        ...
        drawer.classList.add('drawer-open'); // ✅ CORRIGIDO: era 'drawer-visible'
    }
...
window.closeDrawer = function () {
    ...
    const sticky = document.getElementById('sticky-footer');
    if (drawer) {
        drawer.classList.remove('drawer-open'); // ✅ CORRIGIDO: era 'drawer-visible'
...
// --- INIT ---
// ✅ CORRIGIDO: removido bloco do timer antigo (#timer) — timer agora gerenciado pelo script inline no index.html
